            ...
            <div className="flex-1">
              ...
              <div className="bg-white px-4 min-h-fit lg:min-h-[650px]">
                ...
                new Date(auctionDetail.endTime) > Date.now() ? (
                  ...
                  <img
                    src="../../img/Auction_notstart.png"
                    alt="not-started"
                    className="w-full max-h-[650px]"
                  />
                ) : (
                  <img
                    src="../../img/auction_ended.jpg"
                    alt="ended"
                    className="w-full max-h-[650px]"
                  />
                )}
              ...
              <div className="bg-[#4A628A] py-4 text-[16px] md:text-[24px] font-semibold px-4 flex items-center justify-between">
                {Date.now() >= new Date(auctionDetail.startTime) &&
